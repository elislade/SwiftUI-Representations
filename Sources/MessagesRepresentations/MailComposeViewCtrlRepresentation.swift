...
extension  MailComposeViewCtrlRepresentation: UIViewControllerRepresentable {
...
#Preview {
    if MailComposeViewCtrlRepresentation.canSendMail {
        MailComposeViewCtrlRepresentation(subject: "Hello World")
    } else {
